...
which accepts a number and returns true 
if that number contains at least one zero. 
...
function hasNoDuplicates(arr){
    return arr.every(function(val, index){
        return arr.indexOf(val, index+1) == -1;
    })
}
...
which accepts an array of objects and a key, 
...
which accepts an array of objects and a key, 
and a value, and returns true if every single object in the array
