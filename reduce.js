...
returns an object with the keys as the vowel 
and the values as the number of times the vowel appears in the string. 
This function should be case insensitive so a lowercase letter and uppercase 
letter should count
...
function vowelCount(str){
   return str.toLowerCase().replace(/\s+/g,'').split('').reduce(function(accumulator, nextValue){
...
Write a function called partition which accepts an array
 ...
 two arrays inside of it. 
 The partition function should
  run the callback function on each value in the array
   and if the result of the callback function 
   at that specific value is true, 
