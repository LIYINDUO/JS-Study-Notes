/* 
Write a function called displayStudentInfo which accepts an object 
and returns the string "Your full name is" 
concatenated with the value of the first key 
...
which accepts as a parameter, a default parameter 
which is a destructured object 
...
function createStudent({likesES2015=true,likesJavaScript=true}={}){
   if (likesES2015 && likesJavaScript){
       ...
       return 'ERROR, this condition does not have a logic attached to it.'
   }
}

/* 
Write a function called reverseArray which accepts an array 
and returns the array with all values reversed. 
