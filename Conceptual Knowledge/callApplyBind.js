...
function sumEvenArguments(){
    ...
    return arrArg.reduce(function(acc, val){
        if(val%2 ===0){
            acc += val;
        }
        return acc;
...
/* 
Write a function called invokeMax which 
accepts a function and a maximum amount. 
...
Once should return a new function that can only be invoked once, 
...
/* 
Write a function called bind which accepts 
a function and a value for the keyword this. 
Bind should return a new function that when invoked, 
will invoke the function passed to bind with the 
correct value of the keyword this.
 HINT - if you pass more than two parameters to bind,
  those parameters should be included as parameters 
...
function bind(fn, thisArg){
    var outerParas = [].slice.call(arguments,2);
    return function() {
        var innerParas = [].slice.call(arguments);
        var allParas = outerParas.concat(innerParas);
        return fn.apply(thisArg,allParas);
    }
}

/* 
Write a function called flip which accepts a function and a value for the keyword this. 
Flip should return a new function that when invoked, will invoke the function passed to flip with the correct 
value of the keyword this and all of the arguments passed to the function REVERSED. 
HINT - if you pass more than two parameters to flip, those parameters should be included as parameters to the inner function when 
it is invoked. You will have to make use of closure! 
