class MessageBoard {
    ...
    created from the MessageBoard class. 
    The first should be a property called messages which is an empty Map, 
    and the second is a property called id which has a value of 1. 
    ...
    */
    ...
    Add a method called addMessage 
    which accepts a string. 
    The function should add a key and value 
    to the messages map with a key of whatever the value of this.id is and a value of whatever the string is that is passed to the function. 
    The function should return the object created from the class so that the method can be chained. (HINT - to implement the last part, make sure to return this).
    ...
    */
    ...
    /*
    Add a method called findMessageById which accepts a number 
    and returns the message in the messages map 
    ...
    */
    ...
    /*
    Add a method called findMessageByValue 
    which accepts a string and returns the message 
    in the messages map with the same value as the string passed to the function. If the value is not found in the messages map, the function should return undefined.
    ...
    */
    ...
    /*
    Add a method called removeMessage 
    which accepts a number and removes a message 
    ...
    */
    ...
    /*
    Add a method called messagesToArray 
    which returns an array of all of the values in the messages map
...
function uniqueValues(arr){
  var map = new Map;
  arr.forEach(val => map.get(val) === undefined ? map.set(val, 1) : map.set(val, map.get(val)+1))
  return map.size;
}
...
Write a function called countPairs 
which accepts an array of numbers and a number. 
...
function countPairs(arr,sum){
    var map = new Map;
    arr.forEach((val1,index1) => {
        arr.forEach((val2,index2) => {
            if(index1 !== index2 && val1 + val2 === sum){
                map.set(index1+index2,sum);
            }
        })
    })
    return map.size;
